...
#include <conio.h>
	...
	//int eminemX3=  ;
	//int eminemY3=  ;
	//int eminem_stalkerX3= ;
	//int eminem_stalkerY3= ;
...
int main()
{
	...
	while(escolha_menu != 3)
	{
		...
		case (2):
			...
			printf("\t/--------\\                                                                                                  \n");
			printf("\t|  ---   |                                                                                                   \n");
			printf("\t|   |    |___________-> SEU PERSONAGEM INTERAGE COM O ELEMENTO QUE ESTÁ EM CIMA                              \n");
			printf("\t|  ---   |                                                                                                   \n");
			printf("\t\\--------/                                                                                            \n\n\n\n");              
			printf("\t\t& --------> Simbolo que representa o seu personagem;                                                       \n");
			printf("\t\t* --------> Simbolo que representa uma parede, seu personagem ao se movimentar não pode passar pela parede;\n");
			...
			printf("\t\tO --------> Simbolo que representa um botão;                                                               \n");
			printf("\t\t# --------> Simbolo que representa um espinho;                                                             \n");
			printf("\t\t> --------> Simbolo que representa um teletransporte;                                                      \n");
			printf("\t\t¬ --------> Simbolo que representa o monstro nível 1;                                                      \n");
			printf("\t\tK --------> Símbolo que representa o monstro nível 2;                                                      \n");
...
void Jogo()
{
	...
	{
		mapa3(matriz3,x3,y3,chave3,porta3,botao3,eminemY3,eminemX3,eminem_stalkerX3,eminem_stalkerY3);
